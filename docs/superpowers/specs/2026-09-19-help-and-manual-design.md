...
| `socket-card.png` | ソケットの部品カード | ①「選択中」 ②「取り外す」 ③「交換…」 |
...
| `plc-monitor.png` | モードD のモニタ | ①「モニタ開始」 ②「RUN／STOP」 ③「デバイス初期化」 ④「スキャン回数」 ⑤通電の色 |
| `plc-notation.png` | 表記の切替 | ①「表記切替」 ②デバイスの書き方の一覧 ③「この表記に切り替える」 |
| `schematic-editor.png` | 回路図エディタと検算 | ①パレット ②「段を追加」 ③「段を削除」 ④「全部消す」 ⑤「回路図の指摘」 |
