...
| b-021 | B | 3 | 2 | 禁止条件付き運転 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-022 | B | 3 | 2 | 二入力の排他的動作 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-023 | B | 3 | 2 | 三条件の同時成立 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-024 | B | 3 | 2 | 共通許可付き二地点操作 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-025 | B | 3 | 2 | 単独操作と協調操作 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-026 | B | 3 | 2 | 二つの禁止条件 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-027 | B | 3 | 2 | 共通停止付き二地点操作 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-028 | B | 3 | 2 | 二条件成立と第三入力禁止 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-029 | B | 2 | 3 | 三入力の多数決 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-030 | B | 2 | 3 | 一入力だけの選択 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-031 | B | 2 | 3 | 二入力だけの選択 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-032 | B | 2 | 3 | 全一致を除く入力監視 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-033 | B | 2 | 3 | 切替入力で運転条件を選ぶ | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-034 | B | 2 | 3 | 禁止と許可の組合せ | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-035 | B | 2 | 3 | 二経路の選択運転 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-036 | B | 2 | 3 | 許可付き排他操作 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-037 | B | 2 | 3 | 許可付き一致検出 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-038 | B | 2 | 3 | 三入力の奇数検出 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-039 | B | 2 | 3 | 補助入力で禁止を解除 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-040 | B | 2 | 3 | 優先入力付き一致監視 | 論理条件の接点回路化 | 同時押し・解除を含む8通りを確認する |
| b-041 | B | 2 | 3 | 禁止条件付き運転・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-042 | B | 2 | 3 | 二入力の排他的動作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-043 | B | 2 | 3 | 三条件の同時成立・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-044 | B | 2 | 3 | 共通許可付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-045 | B | 2 | 3 | 単独操作と協調操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-046 | B | 2 | 3 | 二つの禁止条件・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-047 | B | 2 | 3 | 共通停止付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-048 | B | 2 | 3 | 二条件成立と第三入力禁止・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-049 | B | 2 | 3 | 三入力の多数決・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-050 | B | 2 | 3 | 一入力だけの選択・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| b-051 | B | 1 | 4 | 禁止条件付き運転・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-052 | B | 1 | 4 | 二入力の排他的動作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-053 | B | 1 | 4 | 三条件の同時成立・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-054 | B | 1 | 4 | 共通許可付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-055 | B | 1 | 4 | 単独操作と協調操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-056 | B | 1 | 4 | 二つの禁止条件・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-057 | B | 1 | 4 | 共通停止付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-058 | B | 1 | 4 | 二条件成立と第三入力禁止・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-059 | B | 1 | 4 | 三入力の多数決・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| b-060 | B | 1 | 4 | 一入力だけの選択・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
...
| d-021 | D | 2 | 3 | PLC 禁止条件付き運転 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-022 | D | 2 | 3 | PLC 二入力の排他的動作 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-023 | D | 2 | 3 | PLC 三条件の同時成立 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-024 | D | 2 | 3 | PLC 共通許可付き二地点操作 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-025 | D | 2 | 3 | PLC 単独操作と協調操作 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-026 | D | 2 | 3 | PLC 二つの禁止条件 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-027 | D | 2 | 3 | PLC 共通停止付き二地点操作 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-028 | D | 2 | 3 | PLC 二条件成立と第三入力禁止 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-029 | D | 2 | 3 | PLC 三入力の多数決 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-030 | D | 2 | 3 | PLC 一入力だけの選択 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-031 | D | 2 | 3 | PLC 二入力だけの選択 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-032 | D | 2 | 3 | PLC 全一致を除く入力監視 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-033 | D | 2 | 3 | PLC 切替入力で運転条件を選ぶ | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-034 | D | 2 | 3 | PLC 禁止と許可の組合せ | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-035 | D | 2 | 3 | PLC 二経路の選択運転 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-036 | D | 2 | 3 | PLC 許可付き排他操作 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-037 | D | 2 | 3 | PLC 許可付き一致検出 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-038 | D | 2 | 3 | PLC 三入力の奇数検出 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-039 | D | 2 | 3 | PLC 補助入力で禁止を解除 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-040 | D | 2 | 3 | PLC 優先入力付き一致監視 | 論理条件のラダー化 | 同時押し・解除を含む8通りを確認する |
| d-041 | D | 1 | 4 | PLC 禁止条件付き運転・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-042 | D | 1 | 4 | PLC 二入力の排他的動作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-043 | D | 1 | 4 | PLC 三条件の同時成立・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-044 | D | 1 | 4 | PLC 共通許可付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-045 | D | 1 | 4 | PLC 単独操作と協調操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-046 | D | 1 | 4 | PLC 二つの禁止条件・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-047 | D | 1 | 4 | PLC 共通停止付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-048 | D | 1 | 4 | PLC 二条件成立と第三入力禁止・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-049 | D | 1 | 4 | PLC 三入力の多数決・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-050 | D | 1 | 4 | PLC 一入力だけの選択・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押し後の再計時を確認 |
| d-051 | D | 1 | 4 | PLC 禁止条件付き運転・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-052 | D | 1 | 4 | PLC 二入力の排他的動作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-053 | D | 1 | 4 | PLC 三条件の同時成立・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-054 | D | 1 | 4 | PLC 共通許可付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-055 | D | 1 | 4 | PLC 単独操作と協調操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-056 | D | 1 | 4 | PLC 二つの禁止条件・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-057 | D | 1 | 4 | PLC 共通停止付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-058 | D | 1 | 4 | PLC 二条件成立と第三入力禁止・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-059 | D | 1 | 4 | PLC 三入力の多数決・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
| d-060 | D | 1 | 4 | PLC 一入力だけの選択・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押し後の再計時を確認 |
