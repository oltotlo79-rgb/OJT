...
①「言葉で探す」、②「目次」、③「説明書（PDF）を開く」、④「閉じる」を図で確認します。
...
3. 図は押すと大きくなります。「説明書（PDF）を開く」でPDFを開き、目次から目的の節へ移ります。
...
| b-021 | B | 3 | 2 | 禁止条件付き運転 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-022 | B | 3 | 2 | 二入力の排他的動作 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-023 | B | 3 | 2 | 三条件の同時成立 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-024 | B | 3 | 2 | 共通許可付き二地点操作 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-025 | B | 3 | 2 | 単独操作と協調操作 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-026 | B | 3 | 2 | 二つの禁止条件 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-027 | B | 3 | 2 | 共通停止付き二地点操作 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-028 | B | 3 | 2 | 二条件成立と第三入力禁止 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-029 | B | 2 | 3 | 三入力の多数決 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-030 | B | 2 | 3 | 一入力だけの選択 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-031 | B | 2 | 3 | 二入力だけの選択 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-032 | B | 2 | 3 | 全一致を除く入力監視 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-033 | B | 2 | 3 | 切替入力で運転条件を選ぶ | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-034 | B | 2 | 3 | 禁止と許可の組合せ | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-035 | B | 2 | 3 | 二経路の選択運転 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-036 | B | 2 | 3 | 許可付き排他操作 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-037 | B | 2 | 3 | 許可付き一致検出 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-038 | B | 2 | 3 | 三入力の奇数検出 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-039 | B | 2 | 3 | 補助入力で禁止を解除 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-040 | B | 2 | 3 | 優先入力付き一致監視 | 3入力の論理条件を接点回路へ変換 | 同時押し・解除を含む8通りを確認する |
| b-041 | B | 2 | 3 | 禁止条件付き運転・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-042 | B | 2 | 3 | 二入力の排他的動作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-043 | B | 2 | 3 | 三条件の同時成立・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-044 | B | 2 | 3 | 共通許可付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-045 | B | 2 | 3 | 単独操作と協調操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-046 | B | 2 | 3 | 二つの禁止条件・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-047 | B | 2 | 3 | 共通停止付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-048 | B | 2 | 3 | 二条件成立と第三入力禁止・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-049 | B | 2 | 3 | 三入力の多数決・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-050 | B | 2 | 3 | 一入力だけの選択・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| b-051 | B | 1 | 4 | 禁止条件付き運転・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-052 | B | 1 | 4 | 二入力の排他的動作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-053 | B | 1 | 4 | 三条件の同時成立・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-054 | B | 1 | 4 | 共通許可付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-055 | B | 1 | 4 | 単独操作と協調操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-056 | B | 1 | 4 | 二つの禁止条件・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-057 | B | 1 | 4 | 共通停止付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-058 | B | 1 | 4 | 二条件成立と第三入力禁止・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-059 | B | 1 | 4 | 三入力の多数決・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| b-060 | B | 1 | 4 | 一入力だけの選択・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
...
| c1-013 | C1 | 3 | 2 | a接点の開閉比較・接点群1 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-014 | C1 | 3 | 2 | b接点の開閉比較・接点群1 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-015 | C1 | 3 | 2 | コイル抵抗と吸引動作・接点群1 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-016 | C1 | 3 | 2 | 同じ非導通でも原因は異なる・接点群1 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-017 | C1 | 3 | 2 | 溶着と正常閉路の識別・接点群1 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-018 | C1 | 3 | 2 | 全接点とコイルの総合点検・接点群1 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-019 | C1 | 2 | 3 | a接点の開閉比較・接点群2 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-020 | C1 | 2 | 3 | b接点の開閉比較・接点群2 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-021 | C1 | 2 | 3 | コイル抵抗と吸引動作・接点群2 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-022 | C1 | 2 | 3 | 同じ非導通でも原因は異なる・接点群2 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-023 | C1 | 2 | 3 | 溶着と正常閉路の識別・接点群2 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-024 | C1 | 2 | 3 | 全接点とコイルの総合点検・接点群2 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-025 | C1 | 2 | 3 | a接点の開閉比較・接点群3 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-026 | C1 | 2 | 3 | b接点の開閉比較・接点群3 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-027 | C1 | 2 | 3 | コイル抵抗と吸引動作・接点群3 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-028 | C1 | 2 | 3 | 同じ非導通でも原因は異なる・接点群3 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-029 | C1 | 1 | 4 | 溶着と正常閉路の識別・接点群3 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-030 | C1 | 1 | 4 | 全接点とコイルの総合点検・接点群3 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-031 | C1 | 1 | 4 | a接点の開閉比較・接点群4 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-032 | C1 | 1 | 4 | b接点の開閉比較・接点群4 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-033 | C1 | 1 | 4 | コイル抵抗と吸引動作・接点群4 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-034 | C1 | 1 | 4 | 同じ非導通でも原因は異なる・接点群4 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-035 | C1 | 1 | 4 | 溶着と正常閉路の識別・接点群4 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
| c1-036 | C1 | 1 | 4 | 全接点とコイルの総合点検・接点群4 | 抵抗・励磁・接点状態の比較 | 正常品と比較し、全接点群を確認する |
...
| c2-021 | C2 | 2 | 3 | 禁止条件付き運転の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-022 | C2 | 2 | 3 | 二入力の排他的動作の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-023 | C2 | 2 | 3 | 三条件の同時成立の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-024 | C2 | 2 | 3 | 共通許可付き二地点操作の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-025 | C2 | 2 | 3 | 単独操作と協調操作の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-026 | C2 | 2 | 3 | 二つの禁止条件の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-027 | C2 | 2 | 3 | 共通停止付き二地点操作の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-028 | C2 | 2 | 3 | 二条件成立と第三入力禁止の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-029 | C2 | 2 | 3 | 三入力の多数決の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-030 | C2 | 2 | 3 | 一入力だけの選択の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-031 | C2 | 2 | 3 | 二入力だけの選択の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-032 | C2 | 2 | 3 | 全一致を除く入力監視の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-033 | C2 | 2 | 3 | 切替入力で運転条件を選ぶの故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-034 | C2 | 2 | 3 | 禁止と許可の組合せの故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-035 | C2 | 2 | 3 | 二経路の選択運転の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-036 | C2 | 2 | 3 | 許可付き排他操作の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-037 | C2 | 2 | 3 | 許可付き一致検出の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-038 | C2 | 2 | 3 | 三入力の奇数検出の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-039 | C2 | 2 | 3 | 補助入力で禁止を解除の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-040 | C2 | 2 | 3 | 優先入力付き一致監視の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-041 | C2 | 1 | 4 | 禁止条件付き運転・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-042 | C2 | 1 | 4 | 二入力の排他的動作・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-043 | C2 | 1 | 4 | 三条件の同時成立・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-044 | C2 | 1 | 4 | 共通許可付き二地点操作・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-045 | C2 | 1 | 4 | 単独操作と協調操作・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-046 | C2 | 1 | 4 | 二つの禁止条件・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-047 | C2 | 1 | 4 | 共通停止付き二地点操作・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-048 | C2 | 1 | 4 | 二条件成立と第三入力禁止・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-049 | C2 | 1 | 4 | 三入力の多数決・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-050 | C2 | 1 | 4 | 一入力だけの選択・継続確認後に点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-051 | C2 | 1 | 4 | 禁止条件付き運転・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-052 | C2 | 1 | 4 | 二入力の排他的動作・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-053 | C2 | 1 | 4 | 三条件の同時成立・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-054 | C2 | 1 | 4 | 共通許可付き二地点操作・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-055 | C2 | 1 | 4 | 単独操作と協調操作・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-056 | C2 | 1 | 4 | 二つの禁止条件・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-057 | C2 | 1 | 4 | 共通停止付き二地点操作・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-058 | C2 | 1 | 4 | 二条件成立と第三入力禁止・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-059 | C2 | 1 | 4 | 三入力の多数決・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
| c2-060 | C2 | 1 | 4 | 一入力だけの選択・開始時だけ点灯の故障診断 | 電圧測定による故障の切り分け | 修復後に全ての入力条件を再確認する |
...
| d-021 | D | 2 | 3 | PLC 禁止条件付き運転 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-022 | D | 2 | 3 | PLC 二入力の排他的動作 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-023 | D | 2 | 3 | PLC 三条件の同時成立 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-024 | D | 2 | 3 | PLC 共通許可付き二地点操作 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-025 | D | 2 | 3 | PLC 単独操作と協調操作 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-026 | D | 2 | 3 | PLC 二つの禁止条件 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-027 | D | 2 | 3 | PLC 共通停止付き二地点操作 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-028 | D | 2 | 3 | PLC 二条件成立と第三入力禁止 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-029 | D | 2 | 3 | PLC 三入力の多数決 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-030 | D | 2 | 3 | PLC 一入力だけの選択 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-031 | D | 2 | 3 | PLC 二入力だけの選択 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-032 | D | 2 | 3 | PLC 全一致を除く入力監視 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-033 | D | 2 | 3 | PLC 切替入力で運転条件を選ぶ | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-034 | D | 2 | 3 | PLC 禁止と許可の組合せ | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-035 | D | 2 | 3 | PLC 二経路の選択運転 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-036 | D | 2 | 3 | PLC 許可付き排他操作 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-037 | D | 2 | 3 | PLC 許可付き一致検出 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-038 | D | 2 | 3 | PLC 三入力の奇数検出 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-039 | D | 2 | 3 | PLC 補助入力で禁止を解除 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-040 | D | 2 | 3 | PLC 優先入力付き一致監視 | 3入力の論理条件をラダーへ変換 | 同時押し・解除を含む8通りを確認する |
| d-041 | D | 1 | 4 | PLC 禁止条件付き運転・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-042 | D | 1 | 4 | PLC 二入力の排他的動作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-043 | D | 1 | 4 | PLC 三条件の同時成立・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-044 | D | 1 | 4 | PLC 共通許可付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-045 | D | 1 | 4 | PLC 単独操作と協調操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-046 | D | 1 | 4 | PLC 二つの禁止条件・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-047 | D | 1 | 4 | PLC 共通停止付き二地点操作・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-048 | D | 1 | 4 | PLC 二条件成立と第三入力禁止・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-049 | D | 1 | 4 | PLC 三入力の多数決・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-050 | D | 1 | 4 | PLC 一入力だけの選択・継続確認後に点灯 | 条件成立が続いた後の出力 | 短押しを繰り返しても計時を累積しない |
| d-051 | D | 1 | 4 | PLC 禁止条件付き運転・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-052 | D | 1 | 4 | PLC 二入力の排他的動作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-053 | D | 1 | 4 | PLC 三条件の同時成立・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-054 | D | 1 | 4 | PLC 共通許可付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-055 | D | 1 | 4 | PLC 単独操作と協調操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-056 | D | 1 | 4 | PLC 二つの禁止条件・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-057 | D | 1 | 4 | PLC 共通停止付き二地点操作・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-058 | D | 1 | 4 | PLC 二条件成立と第三入力禁止・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-059 | D | 1 | 4 | PLC 三入力の多数決・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
| d-060 | D | 1 | 4 | PLC 一入力だけの選択・開始時だけ点灯 | 条件成立時の一定時間出力 | 短押しを繰り返しても計時を累積しない |
