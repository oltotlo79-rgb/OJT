...
/**
 * 内蔵モードD課題100題（`@ojt/content` の `src/builtin/plc/d-001`〜`d-020`、Task 18 db313e1で
...
describe('内蔵モードD課題100題の命令語リスト（§16 Phase 4 / レビュー M5(a)）', () => {
  const programs = loadBuiltinPrograms();

  // 内蔵モードD課題は d-001〜d-100 の100題（`packages/content/src/builtin/plc/`、Task 18 db313e1。
  // v1.7.0 で d-091〜d-100 を追加）。
  it('finds all 100 built-in PLC problems', () => {
