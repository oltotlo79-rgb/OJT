...
内蔵課題は合計 **216題**（モード B 60 / C1 36 / C2 60 / D 60）を同梱しており、追加の
...
**[v1.4.2をダウンロード](https://github.com/oltotlo79-rgb/OJT/releases/tag/v1.4.2)**
...
変更点・確認結果・制約は[リリースノート](docs/releases/v1.4.2.md)をご覧ください。
