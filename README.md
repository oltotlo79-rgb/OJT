...
- **解答操作動画**: ホームと課題画面から4モードの動画を見られます。約2〜5分で、
...
**[v1.6.1をダウンロード](https://github.com/oltotlo79-rgb/OJT/releases/tag/v1.6.1)**
— 保存・復旧とPLC電源の判定を修正し、配線編集・I/O割付・スキャン診断・測定記録・課題作成・108課題・解答動画を追加しました。
...
変更点・確認結果・制約は[リリースノート](docs/releases/v1.6.1.md)をご覧ください。
